...
namespace baeswedding.Controllers
{
    public class SharedController : Controller
    {
        ...
        public ActionResult _Comments()
        {
            SQL sql = new SQL();
            ModelState.Clear();
            return PartialView("_Comments", sql.GetComments());
        }
        ...
        [HttpPost]
        public ActionResult AddComment(CommentModel cmodel)
        {
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["connBae"].ToString());
            con.Open();
            ...
            cmd.Parameters.AddWithValue("@comment", cmodel.Comment);
            cmd.ExecuteNonQuery();

            con.Close();

            return View("/averyadmin/Comments");
        }
